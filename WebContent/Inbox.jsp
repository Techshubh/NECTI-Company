...
<div class="w3-row w3-padding-20">
  <h1 class="w3-text-teal" align="center">Inbox</h1>
  </div>
<table>
  <tr>
    <th>Name</th>
...
<%//out.print("<h2 align='center'>Inbox</h2>");
//out.print("<h3>Welcome "+session.getAttribute("username")+"</h3>");

try{
Connection con=(Connection)session.getAttribute("connection");

String query = "select * from inbox where name='" + (String)session.getAttribute("email") + "'";
...
out.print(" <tr><td>"+fname+"</td><td>"+sub+"</td><td>"+body+"<td>"+date+"</td></tr>");
